...
export default function MenuSection() {
  ...
  return (
    <section id="menu" className="page-section relative bg-[var(--color-base)]">
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="mb-16 text-center">
            ...
            <h1 className="mt-4 font-[family-name:var(--font-cormorant)] text-4xl font-light tracking-[0.3em] text-gold-gradient uppercase sm:text-5xl">
              {t(activeBook.title)}
            </h1>
