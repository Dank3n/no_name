...
export const siteConfig = {
  ...
  hero: {
    subtitle: {
      ro: "Bucătărie românească · Terasă · Seri până la 2:00",
      en: "Romanian cuisine · Terrace · Open until 2:00",
      it: "Cucina rumena · Terrazza · Aperto fino alle 2:00",
      es: "Cocina rumana · Terraza · Abierto hasta las 2:00",
      fr: "Cuisine roumaine · Terrasse · Ouvert jusqu'à 2h00",
      tr: "Romen mutfağı · Teras · 02:00'e kadar açık",
      ru: "Румынская кухня · Терраса · До 2:00",
      ar: "مطبخ روماني · تراس · مفتوح حتى 2:00",
    },
