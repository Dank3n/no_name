...
export const uiTranslations: UiTranslationTree = {
  ...
  gallery: {
    ...
    pageDesc: L(
      "Imagini din restaurant, de pe terasă și de la masă — NO NAME by Casa Ede.",
      "Photos from the restaurant, the terrace and the table — NO NAME by Casa Ede.",
      "Foto dal ristorante, dalla terrazza e dalla tavola — NO NAME by Casa Ede.",
      "Fotos del restaurante, la terraza y la mesa — NO NAME by Casa Ede.",
      "Photos du restaurant, de la terrasse et de la table — NO NAME by Casa Ede.",
      "Restoran, teras ve masadan fotoğraflar — NO NAME by Casa Ede.",
      "Фото ресторана, террасы и стола — NO NAME by Casa Ede.",
      "صور من المطعم والتراس والمائدة — NO NAME by Casa Ede."
    ),
    ...
    teaserDesc: L(
      "Câteva cadre din restaurant și de pe terasă. Restul pozelor sunt în galerie.",
      "A few frames from the restaurant and terrace. The rest of the photos are in the gallery.",
      "Qualche scatto dal ristorante e dalla terrazza. Il resto è in galleria.",
      "Algunas fotos del restaurante y la terraza. El resto está en la galería.",
      "Quelques images du restaurant et de la terrasse. Le reste est dans la galerie.",
      "Restoran ve terastan birkaç kare. Geri kalanı galeride.",
      "Несколько кадров из ресторана и с террасы. Остальное — в галерее.",
      "لقطات من المطعم والتراس. بقية الصور في المعرض."
    ),
