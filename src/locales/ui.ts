...
export const uiTranslations: UiTranslationTree = {
  ...
  highlights: {
    ...
    cardDessertTitle: L("Cheesecake, la final", "Cheesecake, to finish", "Cheesecake, per chiudere", "Cheesecake, para cerrar", "Cheesecake, pour finir", "Cheesecake, final için", "Чизкейк — на финал", "تشيزكيك في الختام"),
    cardDessertText: L(
      "O felie cremoasă și scuza perfectă să mai stai un pic.",
      "A creamy slice and the perfect excuse to stay a little longer.",
      "Una fetta cremosa e la scusa perfetta per restare ancora un po'.",
      "Una porción cremosa y la excusa perfecta para quedarte un rato más.",
      "Une part crémeuse et l'excuse parfaite pour rester encore un peu.",
      "Kremalı bir dilim ve biraz daha kalmak için mükemmel bahane.",
      "Нежный кусочек и идеальный повод задержаться ещё немного.",
      "قطعة كريمية والعذر المثالي لتبقى قليلاً."
    ),
  ...
  gallery: {
    ...
    crispy: L("Crispy", "Crispy", "Crispy", "Crispy", "Crispy", "Crispy", "Криспи", "كريسبي"),
    burger: L("Burger", "Burger", "Burger", "Hamburguesa", "Burger", "Burger", "Бургер", "برغر"),
    ribs: L("Coaste", "Ribs", "Costine", "Costillas", "Travers", "Kaburga", "Рёбра", "أضلاع"),
    shrimp: L("Creveți", "Shrimp", "Gamberi", "Gambas", "Crevettes", "Karides", "Креветки", "روبيان"),
    skillet: L("La tigaie", "Skillet", "In padella", "A la sartén", "À la poêle", "Tavada", "На сковороде", "في المقلاة"),
    seafoodPasta: L("Paste cu fructe de mare", "Seafood pasta", "Pasta ai frutti di mare", "Pasta de mariscos", "Pâtes aux fruits de mer", "Deniz mahsullü makarna", "Паста с морепродуктами", "معكرونة بالمأكولات البحرية"),
    penne: L("Penne", "Penne", "Penne", "Penne", "Penne", "Penne", "Пенне", "بيني"),
    cheesecake: L("Cheesecake", "Cheesecake", "Cheesecake", "Cheesecake", "Cheesecake", "Cheesecake", "Чизкейк", "تشيزكيك"),
    latte: L("Cafea", "Coffee", "Caffè", "Café", "Café", "Kahve", "Кофе", "قهوة"),
